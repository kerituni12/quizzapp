    ...
    <View style={styles.modalContent}>
      <FlatList
          style={styles.scrollableModal}
            data={[{key: 'fsdfsssssssssssssssssssssssssssssssssssffda'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}, {key: 'b'}]}
            //keyExtractor={({item, index}) => index}
            renderItem={({item, index}) => this.renderAnswer(item.key, index)}
          />
      <Text>Hello!</Text>
