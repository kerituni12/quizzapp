                        ...
                        renderItem={({item}) => (
                            <View style={styles.OptionButton}>
                                <TouchableOpacity
                                    ...
                                    onPress={(event) => { this.checkAnswer(event, item.key) ; this.props.chuyen; }}>
                                        ...
                                        <View style={{position: 'absolute', height: 25, width: 25, right: 5, top: 10}}>
                                            {                                           
                                                this.state.selectedAnswer === item.key ? (
                                                    ...
                                                    ) : (item.key===this.state.correct && this.state.one===false ?  (<Icon name="check-circle" size={25} color="#83B63E" />) :null )
                                            }
